...
'''
This sample shows Azure Functions in Python doing some time series forecasting
using autoregression models with statsmodel libraries. This demonstrates
retraining of time series models with newer data using Azure Functions.
Statsmodel depends on pystan and this demonstrates ML library installation challenges
